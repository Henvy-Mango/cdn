    ...
    var action = {
        ...
        welcome: function () {
            if (document.referrer !== "" && document.referrer.indexOf(current.root) === -1) {
                ...
                if (prop.content.referer)
                    modules.render(prop.content.referer.replace(/%t/, "“" + referrer.hostname + "”"))
                else
                if (referrer.hostname == "pic.naomi.pub" || referrer.hostname == "git.naomi.pub")
                    modules.render("你回来啦");
                else
        ...
        onmouse: function () {
            ...
            current.canvas.onmouseover = function () {
                modules.render(prop.content.onmouse || ["干嘛呢你，快把手拿开", "鼠……鼠标放错地方了", "给爷爪巴"]);
            };
        },
        // 触摸
        touch: function () {
            current.canvas.onclick = function () {
                modules.render(prop.content.touch || ["你在干什么？", "再摸我就报警了！", "HENTAI!", "不可以这样欺负我啦！", "爪巴"]);
            };
        },
        // 右侧按钮
        buttons: function () {
            ...
            elements.info.onclick = function () {
                window.open(prop.content.link || "https://naomi.pub/about.html");
            };
